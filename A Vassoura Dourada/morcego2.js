var Morcego2 = function() {
	...
	for (var i = 0; i < this.numFrames; i++) {
		...
		this.animacao[i].src = "IMAGEM/Jogo/Inimigos/Morcego2/bat2_" + (i + 1) + ".png";
	}
		
	for (var i = 0; i < this.numFrames; i++) {
		this.animacao_morrendo[i] = new Image();
		this.animacao_morrendo[i].src = "IMAGEM/Jogo/Inimigos/Morcego2/morte/bat2_morte" + (i + 1) + ".png";
	}
